...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white mt-auto border-t border-gray-200 dark:border-gray-800 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-2 py-1 bg-gray-200 dark:bg-gray-800 rounded text-xs text-gray-700 dark:text-gray-300">
                ⚡ Web3
              </span>
              <span className="px-2 py-1 bg-gray-200 dark:bg-gray-800 rounded text-xs text-gray-700 dark:text-gray-300">
                🔐 Secure
            ...
            <div className="space-y-2">
              ...
              {isContractDeployed ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 dark:bg-gray-800 rounded-lg hover:bg-blue-700 dark:hover:bg-gray-700 transition-all text-sm font-medium text-white"
                >
                  <span>🔍</span>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              >
                <div className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-lg flex items-center justify-center group-hover:bg-gray-300 dark:group-hover:bg-gray-700 transition-colors">
              ...
              <a
                ...
                className="flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors group"
              >
                <div className="w-10 h-10 bg-indigo-200 dark:bg-indigo-800 rounded-lg flex items-center justify-center group-hover:bg-indigo-300 dark:group-hover:bg-indigo-700 transition-colors">
              ...
              <a
                ...
                className="flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors group"
              >
                <div className="w-10 h-10 bg-purple-200 dark:bg-purple-800 rounded-lg flex items-center justify-center group-hover:bg-purple-300 dark:group-hover:bg-purple-700 transition-colors">
                  <span className="text-xl">📚</span>
                </div>
                <div>
        ...
        {/* Divider */}
        <div className="border-t border-gray-300 dark:border-white/10 mt-6 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 text-xs text-gray-700 dark:text-gray-400">
                <span className="px-2 py-1 bg-indigo-100 dark:bg-indigo-900/50 rounded">⚡ Next.js</span>
                <span className="px-2 py-1 bg-purple-100 dark:bg-purple-900/50 rounded">🔷 Solidity</span>
                <span className="px-2 py-1 bg-pink-100 dark:bg-pink-900/50 rounded">🌐 Wagmi</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-gray-600 dark:text-gray-500">
              {isContractDeployed ? (
                <span className="text-green-600 dark:text-green-400">✅ Contract đang hoạt động trên Chain ID: {chainId}</span>
              ) : (
                <span className="text-yellow-600 dark:text-yellow-400">⚠️ Vui lòng chuyển sang mạng đã deploy contract</span>
              )}
            </p>
          </div>
        </div>
